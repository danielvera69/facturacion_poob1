...
class Sale(Icalculo):
    ...
    # implementacion del metodo cal_iva de la interfaz Icalculo
    def cal_iva(self,iva=0.12,valor=0):
        return round(valor*iva,2)
     # implementacion del metodo cal_discount de la interfaz Icalculo
    def cal_discount(self,valor=0,discount=0):
        return round(valor*discount,2)
    
    def add_detail(self,prod,qty):
        # relacion de composicion entre detventa y venta
        # si se destruye venta tambien se destruye detventa
...
# para cumplir con la relacion de agregacion de cliente con venta
# solo se le envia la instancia
sale1 = Sale(cli1)
# para cumplir con la relacion de agregacion de producto con detventa
# solo se le envia la instancia
sale1.add_detail(product1,5)
sale1.add_detail(product2,10)
# relacion de asociacion entre venta y empresa
